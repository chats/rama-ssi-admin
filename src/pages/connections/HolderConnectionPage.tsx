...
const HolderConnectionPage: React.FC = () => {
  ...
  const getConnection = async() => {
    setLoading(true)
    try {
      const connectionService = new ConnectionService(HolderAgent);
  ...
  return (
    <>
      {contextHolder}
      <Title level={2}>Holder Connections</Title>
      <p>Manage SSI holder's connections with other entities</p>
...
export default HolderConnectionPage;